  ...
  return (
    <div className='relative min-h-full overflow-hidden'>
      <img
        src={imageUrl}
        alt='Background'
        className='absolute inset-0 min-w-full object-fill object-center opacity-20 '
      />
      <div className='relative'>
        <div className='p-6'>
          ...
          <br></br>
          <p className='font-roboto text-primary'>
            Due to the sheer scale of this project, along with personal time contraints, the project
