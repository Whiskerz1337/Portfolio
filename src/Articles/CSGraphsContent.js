      ...
      <div className='relative'>
        <div className='p-6'>
          ...
          <p className='font-roboto text-primary'>
            ...
            &apos;Concurrently&apos; package. The server is running Express, and contains the logic
            for the database connection, as well as timed price update scripts.
          </p>
          <br></br>
          <p className='font-roboto text-primary'></p>
