      ...
      <div className=' mb-8 mt-4 flex flex-col items-center justify-center border-t-2 border-arcade'>
        <div className='mx-2 sm:mx-72'>
          ...
          <p className='text-center font-roboto text-base leading-relaxed text-primary sm:text-base'>
            Hi, I&apos;m Luke, a British cybersecurity enthusiast and software developer
            based in the West Midlands, UK. My unrelenting passion for technology has driven me to
            merge my expertise in cybersecurity with my proficiency in software development.
          </p>
          <br></br>
          <p className='text-center font-roboto text-base leading-relaxed text-primary sm:text-base'>
            Having successfully completed the both the Certificate IV and the Advanced Diploma in Cybersecurity (Australia), 
            I&apos;m now pursuing PEN-200 OSCP certification to further expand my knowledge. My proficiency in
